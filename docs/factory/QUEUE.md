...
| CLS-5 | queued | Story + photos (show what the children did) |
| CLS-6 | queued | Announcements: no reply, react, read |
| CLS-7 | queued | Feed, mentions, threads |
| CLS-8 | queued | Direct messages |
